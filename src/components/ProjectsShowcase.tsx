...
export default function ProjectsShowcase() {
  ...
  return (
    <section
      id="projects"
      className="py-24 md:py-32 px-6 md:px-12 max-w-7xl mx-auto border-b border-on-surface"
    >
      {/* Header Panel */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-20 gap-6 border-b border-on-surface pb-8">
        <div>
          ...
          <p className="font-serif italic text-base sm:text-lg text-on-surface-variant max-w-xl mt-3">
            A precise collection of digital artifacts crafted with high-fidelity
            UI systems, backend integrations, and smooth client workflows.
          </p>
        </div>
        ...
        {personalData.projects.map((project, index) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`lg:col-span-7 bg-[#FAF9F6] p-2.5 border border-on-surface shadow-sm relative ${isEven ? "lg:order-1" : "lg:order-2"}`}
              >
        ...
        {activeProject && (
          ...
          >
            <motion.div
              ...
              className="glass-card w-[95vw] sm:w-full max-h-[92vh] max-w-md sm:max-w-xl bg-white rounded-none border border-on-surface overflow-hidden flex flex-col shadow-xl"
            >
              {/* Modal Header banner */}
              <div
              ...
              {/* Modal Contents Area */}
              <div className="p-4 sm:p-8 space-y-4 sm:space-y-6 overflow-y-auto max-h-[58vh] sm:max-h-[52vh] custom-scroll scrollbar">
                <div>
                ...
                <div>
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    {activeProject.features.map((feat, idx) => (
                      <li
                        key={idx}
                        className="flex gap-2.5 items-start bg-[#FAF9F6] p-3 border border-on-surface/20"
                      >
              ...
              <div className="bg-[#FAF9F6] border-t border-on-surface p-3 sm:p-5 flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <div className="flex flex-col w-full sm:w-auto sm:flex-row gap-2.5">
                  {activeProject.liveDemo && (
                    ...
                    >
                      <span className="material-symbols-outlined text-xs font-bold font-mono">
                        launch
                      </span>
